...
const Checkout = () => {
  const { getCartPageData, postOrder, postAddress, checkPorductAvailability } =
    UserService();
  ...
  const handleChange = (e) => {
    ...
    if (name === "selectedProduct") {
      setSelectedProduct(value); // update the selected product state
    } else {
                  ...
                  <div className="row">
                    <aside className="col-lg-3">
                      <div className="summary">
                        ...
                        {/* End .summary-title */}
                        <table className="table table-summary w-full border-collapse">
                          <thead>
                            <tr>
                              {" "}
