                  ...
                  {wishlist?.map((data) => (
                    <tr key={data._id}>
                      ...
                      <td className="remove-col">
                        <button className="btn-remove" onClick={() => handleRemove(data._id)}>
...
//                       <td className="action-col">
//                         <button className="btn btn-block btn-outline-primary-2"><i className="icon-cart-plus" onClick={() => handleAddToCart(data._id, 1)} />Add to Cart</button>
//                       </td>
