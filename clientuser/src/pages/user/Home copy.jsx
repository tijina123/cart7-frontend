...
const Home = () => {
  ...
  console.log(allProducts,"=======allProducts");
    ...
    function getData() {
      fetch("http://localhost:3000/product") // Replace with your API URL
      ...
      {allProducts?.map((products) => (
        ...
        <div className="tab-content tab-content-carousel">
            <div className="tab-pane p-0 fade show active" id="hot-all-tab" role="tabpanel" aria-labelledby="hot-all-link">
              <ProductCarousel products={products.products} handleAddToCart={handleAddToCart} handleAddToWishlist={handleAddToWishlist} />
            </div>{/* .End .tab-pane */}
