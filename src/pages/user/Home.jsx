  ...
  return (
    <div className="page-wrapper">
      <main className="main">
        <div className="intro-slider-container">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "url(assets/images/demos/demo-13/slider/slider-1.png)",
              }}
            >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(assets/images/demos/demo-13/slider/slider-2.png)",
                objectFit: "contain",
              }}
            >
              <div className="container intro-content">
                <div className="row">
                  <div className="col-auto offset-lg-3 intro-col"></div>
                  {/* End .col-auto offset-lg-3 */}
                </div>
                {/* End .row */}
              </div>
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(assets/images/demos/demo-13/slider/slider-3.png)",
                objectFit: "contain",
              }}
            >
              <div className="container intro-content">
          ...
          <div className="row">
            <div className="col-sm-6 col-lg-3">
              <div className="banner banner-overlay">
                <a>
                  <img
                    src="assets/images/demos/demo-13/banners/banner-1.png"
                    alt="Banner"
                  />
                </a>
            ...
            <div className="col-sm-6 col-lg-3 order-lg-last">
              <div className="banner banner-overlay">
                <a>
                  <img
                    src="assets/images/demos/demo-13/banners/banner-3.png"
                    alt="Banner"
                  />
                </a>
                <div className="banner-content">
            ...
            <div className="col-lg-6">
              <div className="banner banner-overlay">
                <a>
                  <img
                    src="assets/images/demos/demo-13/banners/banner-2.png"
                    alt="Banner"
                  />
                </a>
                <div className="banner-content">
        ...
        {/* End .container */}
        <div className="mb-3 filter-products" />
        {/* End .mb-3 */}
        <div className="bg-light pt-3 pb-5 ">
          ...
          {allProducts?.map((products) => {
            if (products.products.length > 0) {
              return (
                <div
                  className={`container ${products.name}`}
                  key={products._id}
                >
                  <div className="heading heading-flex heading-border mb-3">
                    <div className="heading-left">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="banner banner-overlay banner-overlay-light">
                <a>
                  <img
                    src="assets/images/demos/demo-13/banners/banner-4.png"
                    alt="Banner"
                  />
                </a>
                <div className="banner-content">
